...
const GANH88_URL = 'http://103.77.242.186/web/';
const GANH88_LOGO = 'https://res.cloudinary.com/df2amyjzw/image/upload/v1775745095/ganhgame_g8zdu4.png';
...
export default function Ganh88Screen() {
    ...
    return (
        <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
            <View style={styles.header}>
                ...
                <Image source={{ uri: GANH88_LOGO }} style={styles.headerLogo} contentFit="contain" />
...
const styles = StyleSheet.create({
    ...
    loaderOverlay: {
        ...
        alignItems: 'center',
        justifyContent: 'center',
        backgroundColor: 'rgba(9, 21, 50, 0.84)',
        gap: 10,
    },
    loaderText: {
        color: '#E7EEFF',
